...
export type GetPaths =
  ...
  | {
      ...
      path: `discount_codes/lookup?code=SUMMERSALE10OFF`;
      query: {
  ...
  | {
      ...
      path: `events/count?created_at_min=2008-01-10T13:00:00+00:00`;
      query: {
  ...
  | {
      ...
      path: `inventory_items?ids=808950810,39072856,457924702`;
      query: {
  ...
  | {
      ...
      path: `metafields?metafield[owner_id]=850703190&amp;metafield[owner_resource]=product_image`;
      query: {
  ...
  | {
      ...
      path: `comments/count?article_id=134645308&amp;blog_id=241253187`;
      query: {
  ...
  | {
      ...
      path: `comments?article_id=134645308&amp;blog_id=241253187`;
      query: {
  ...
  | {
      ...
      last_characters
      Note: As of version 2019-10, this endpoint implements pagination by using links that are provided in the response header. Sending the page parameter will return an error. To learn more, see Making requests to paginated REST Admin API endpoints.  */
      path: `gift_cards/search?query=last_characters:mnop`;
      query: {
        /** Show only certain fields, specified by a comma-separated list of field names. */
        fields?: string;
        /** The maximum number of results to retrieve. */
  ...
  | {
      ...
      path: `custom_collections/count?product_id=632910392`;
      query: {
  ...
  | {
      ...
      path: `assigned_fulfillment_orders?assignment_status=cancellation_requested&amp;location_ids[]=24826418`;
      query: {
